...
define dso_local i32 @add2(i32 %a, i32 %b) local_unnamed_addr #0 {
entry:
  %add = add i32 %b, %a
  ret i32 %add
}
...
!7 = !{!"clang version 14.0.0 (https://github.com/llvm/llvm-project.git 778440f1996f2a442fb691058b97bbb0a9cf7300)"}
