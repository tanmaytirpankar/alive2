...
vector.body731:                                   ; preds = %vector.body731, %entry
  ...
  %strided.vec746 = shufflevector <32 x i16> %wide.vec745, <32 x i16> poison, <16 x i32> <i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14, i32 16, i32 18, i32 20, i32 22, i32 24, i32 26, i32 28, i32 30>
